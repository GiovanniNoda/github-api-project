...
export function Search() {
    ...
    async function handleSearch(event: React.FormEvent) {
        ...
        try {
            const userData = await getApiUserGithub(username)
        ...
        <form className="max-w-[864px] w-full mb-20" onSubmit={handleSearch}>
            <fieldset>
                ...
                <div className="flex justify-between items-center">
                    <input type="text" placeholder="Buscar usuário" className="w-[80%] bg-blue-dark-300 py-3 px-4 rounded-md border border-gray-500 text-white placeholder:text-gray-400" onChange={(e) => setUsername(e.target.value)} />
